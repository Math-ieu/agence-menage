            ...
            <div className="bg-card rounded-lg p-6 border shadow-sm space-y-6">
              <div>
                ...
                <RadioGroup
                  ...
                  className="space-y-2 p-4 bg-muted/30 rounded"
                >
                  {[
                    ...
                    <div key={freq.value} className="flex items-center space-x-2">
                      <RadioGroupItem value={freq.value} id={`garde-${freq.value}`} />
                      <Label htmlFor={`garde-${freq.value}`}>{freq.label}</Label>
                    </div>
                  ))}
                </RadioGroup>
              </div>
                ...
                <div className="bg-accent/20 rounded-lg p-4 space-y-3">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      <span>Fréquence :</span>
                      <span className="font-medium">Occasionnel</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Date :</span>
                      <span className="font-medium">le 02/12/2025</span>
                    </div>
                    <div className="flex justify-between">
