      ...
      <main className="flex-1 bg-background py-12">
        <div className="container max-w-4xl">
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="bg-service-purple/10 rounded-lg p-6 text-center">
              <h2 className="text-2xl font-bold text-service-purple mb-2">
            ...
            <div className="bg-card rounded-lg p-6 border shadow-sm space-y-6">
              <div>
                <h3 className="text-xl font-bold bg-service-purple text-white p-3 rounded-lg mb-4">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-service-purple/10 rounded-lg p-4 space-y-3">
                  ...
                  <div className="border-t pt-3 mt-3">
                    <div className="text-2xl font-bold text-service-purple text-center border-2 border-service-purple rounded-lg p-3">
                      {totalPrice} DH
                    </div>
                  </div>
                </div>
                ...
                >
                  {["Domicile", "Clinique", "Hôpital"].map((location) => (
                    <div key={location} className="flex items-center space-x-2">
                      <RadioGroupItem value={location.toLowerCase()} id={location} />
              ...
              <div className="bg-service-purple/10 rounded-lg p-6">
                <h3 className="text-xl font-bold bg-service-purple text-white p-3 rounded-lg mb-4">
                    ...
                    >
                      {["Adulte", "Personne Agée", "Autonome", "Besoin d'aide", "Alité(e)"].map((mob) => (
                        <div key={mob} className="flex items-center space-x-2">
                          <RadioGroupItem value={mob} id={mob} />
              ...
              <div className="bg-muted/30 rounded-lg p-6">
                <h3 className="text-xl font-bold bg-service-purple text-white p-3 rounded-lg mb-4 -m-6 mb-4">
                  Mes informations
                </h3>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
              ...
              <div className="text-center pt-4">
                <Button
                  type="submit"
                  size="lg"
                  className="px-12 bg-service-purple hover:bg-service-purple/90 text-white"
                >
