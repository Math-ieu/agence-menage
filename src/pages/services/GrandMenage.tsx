        ...
        <div className="container max-w-4xl">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="bg-card rounded-lg p-6 border shadow-sm space-y-6">
              <div>
                <h3 className="text-xl font-bold bg-accent text-foreground p-3 rounded-t-lg">
                  Type d'habitation
                </h3>
                <RadioGroup
                ...
                >
                  {["Studio", "Appartement", "Duplex", "Villa", "Maison"].map((type) => (
                    <div key={type} className="flex items-center space-x-2">
                      <RadioGroupItem value={type.toLowerCase()} id={`gm-${type}`} />
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h3 className="text-xl font-bold bg-accent text-foreground p-3 rounded-lg mb-4">
                  ...
                  >
                    {[
                      ...
                      <div key={freq.value} className="flex items-center space-x-2">
                        <RadioGroupItem value={freq.value} id={`gm-${freq.value}`} />
                        <Label htmlFor={`gm-${freq.value}`}>{freq.label}</Label>
                      </div>
                    ))}
                  </RadioGroup>
                </div>
                ...
                <div className="bg-accent/20 rounded-lg p-4 space-y-3">
                  ...
                  <div className="border-t pt-3 mt-3">
                    <div className="text-2xl font-bold text-accent-foreground text-center border-2 border-accent rounded-lg p-3">
                      {totalPrice} DH
                    </div>
                  </div>
                </div>
                  ...
                  <div className="text-center">
                    ...
                    >
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="morning" id="gm-morning" />
                        <Label htmlFor="gm-morning">Le matin (09h 00 - 12h 00)</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="afternoon" id="gm-afternoon" />
                        <Label htmlFor="gm-afternoon">L'après midi (13h 00 - 18h 00)</Label>
                      </div>
                    </RadioGroup>
                  </div>
                  <div className="text-center">
              ...
              <div className="bg-muted/30 rounded-lg p-6">
                <h3 className="text-xl font-bold bg-accent text-foreground p-3 rounded-lg mb-4 -m-6 mb-4">
                  Mes informations
                </h3>
              ...
              <div className="text-center pt-4">
                <Button
                  type="submit"
                  size="lg"
                  className="px-12 bg-accent hover:bg-accent/90 text-foreground"
                >
